...
public class SelectArtworkKind extends JFrame implements ActionListener {
	...
	public SelectArtworkKind() {
		...
		jl1 = new JLabel("è‰ºæœ¯å“�ç±»åˆ«æŸ¥è¯¢ç³»ç»Ÿ");
		jl2 = new JLabel("ç±»åˆ«");
	...
	public int verify() {
		...
		try {
			if (!jt1.getText().isEmpty()) {
				...
				if (rs1.first()) {
					JOptionPane.showMessageDialog(null, "è¯¥ç±»åˆ«å­˜åœ¨", "æ��ç¤ºæ¶ˆæ�¯", JOptionPane.WARNING_MESSAGE);
					result = 1;
				} else {
					JOptionPane.showMessageDialog(null, "è¯¥ç±»åˆ«ä¸�å­˜åœ¨ï¼Œè¯·é‡�æ–°è¾“å…¥", "æ��ç¤ºæ¶ˆæ�¯", JOptionPane.WARNING_MESSAGE);
				}
			} else {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand() == "ç¡®å®š") {
			if (verify() == 1) {
				new SelectArtworkKindout(); //è°ƒç”¨å¯¹åº”Outç±»
				dispose();
